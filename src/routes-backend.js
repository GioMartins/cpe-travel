...
routes.put("/usuario/:usuarioId", 
    UsuarioValidator.update ,
    UsuarioController.update); 

routes.delete("/usuario/:usuarioId", 
    UsuarioValidator.delete ,
    UsuarioController.delete); 

// configuracao rota /local 
routes.get("/local/:localId/:usuarioId", LocalValidator.getByLocal, LocalController.getByLocal);
