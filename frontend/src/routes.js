  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route exact path="/RioDeJaneiro" render={(props) => <Local {...props} local="RioDeJaneiro" images={initialImages} />} />
        <Route exact path="/Salvador" render={(props) => <Local {...props} local="Salvador" images={initialImages} />} />
        <Route exact path="/Olinda" render={(props) => <Local {...props} local="Olinda" images={initialImages} />} />
        <Route exact path="/Amsterdam" render={(props) => <Local {...props} local="Amsterdam" images={initialImages} />} />
        <Route exact path="/Paris" render={(props) => <Local {...props} local="Paris" images={initialImages} />} />
        <Route exact path="/Porto" render={(props) => <Local {...props} local="Porto" images={initialImages} />} />
        <Route exact path="/NovaYork" render={(props) => <Local {...props} local="NovaYork" images={initialImages} />} />
        <Route exact path="/IPhiPhi" render={(props) => <Local {...props} local="IPhiPhi" images={initialImages} />} />
        <Route exact path="/MLake" render={(props) => <Local {...props} local="MLake" images={initialImages} />} />
